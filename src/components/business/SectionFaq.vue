...
const faqs = ref({
  ...
  uiux: [
    ...
    },
    {
      ...
      a: '其會有的，屆時平台投稿流程上，會讓您的作品可以選擇 CC0、CC BY 等授權，以保障您的 UI 作品權益。',
    },
    {
      q: '一定要上傳「線上標示文件」嗎？',
  ...
  <section class="section-faq">
    ...
    <div class="wrapper">
      <div class="tabs">
        <div
          class="tabs__tab"
          :class="{ 'tabs__tab--active': activeTab === 'common' }"
        ...
        <div
          class="tabs__tab"
          :class="{ 'tabs__tab--active': activeTab === 'uiux' }"
          @click="switchTab('uiux')"
        >
          UI 設計師
        </div>
        <div
          class="tabs__tab"
          :class="{ 'tabs__tab--active': activeTab === 'frontend' }"
        ...
        <div
          class="tabs__tab"
          :class="{ 'tabs__tab--active': activeTab === 'group' }"
      ...
      <section class="tabs__content">
        <div class="faq">
          <div v-for="aFaq in faqs[activeTab]" :key="aFaq.q">
            <h3 class="color-primary-light">Ｑ：{{ aFaq.q }}</h3>
            <p>Ａ：{{ aFaq.a }}</p>
          </div>
        </div>
      </section>
